  ...
  return (
    <section className='relative flex items-center text-center h-screen xl:items-left xl:text-left xl:h-screen'>
        <div className="content z-10 px-3 mt-44 pb-8 w-full max-w-xl md:w-[100%] md:mt-44 md:mx-auto xl:w-[100%] xl:mt-24 xl:mx-0 xl:px-16">
            <img className='w-32 mx-auto mb-4 xl:w-48 xl:mx-0 xl:mb-9' src={logo} alt="disney+ logo" />
            <h1 className='mb-4 text-2xl xl:text-4xl font-sbold xl:mb-6'>+ More than you'd ever imagine</h1>
            <p className='text-[#c0c0c0] xl:text-lg'>Enter your email to create or restart your subscription.</p>
            ...
            <p className='mt-5 text-[#c0c0c0] xl:text-xl'>
