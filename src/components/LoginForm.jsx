...
import { signInWithGoogle, signInWithEmail, SignOut } from '../firebase';
...
const LoginForm = () => {
  ...
  return (
    <div className='flex flex-col  px-4 py-8 gap-4 xl:px-10 md:w-[50%] md:mx-auto xl:py-6 lg:w-[50%] lg:mx-auto xl:w-[40%] xl:mx-auto xl:gap-5'>
            ...
            <form onSubmit={handleSubmit(signInWithEmail)} className='flex flex-col gap-3 xl:gap-2'>
            ...
            <div className='flex flex-col gap-4 w-full'>
                <button onClick={signInWithGoogle} className='flex justify-center items-center gap-3 bg-white w-full py-3 rounded-lg cursor-pointer'>
