    ...
    <div className="flex flex-col px-3 py-4 xl:px-8 xl:py-5">
      ...
      <div className="relative mt-8">  
        <div className="absolute z-10 px-5 xl:px-12 my-14 flex flex-col gap-5 xl:gap-7 w-[100%] xl:w-[70%]">
          <img className="w-48" src={`https://image.tmdb.org/t/p/original/${data.production_companies[0].logo_path}`} alt='company' />
        ...
        <div className="absolute top-0 bottom-0 left-0 right-0 min-w-[200px] h-[600px] md:min-w-[260px] md:h-[500px] object-cover"><img className="w-full h-full object-cover opacity-50" src={`https://image.tmdb.org/t/p/original/${data?.backdrop_path || data?.poster_path}`} /></div>
      </div>
